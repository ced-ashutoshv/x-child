...
if ( ! apply_filters( '	', true, $item ) ) {
	return;
}
$is_visible        = $product && $product->is_visible();
$product_permalink = apply_filters( 'woocommerce_order_item_permalink', $is_visible ? $product->get_permalink( $item ) : '', $item, $order );
?>
<div class="row <?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	<div class="col-auto product-thumbnail d-flex align-items-center">
		...
		<img style="max-width:170px;" src="<?php echo $image[0]; ?>">
	</div>
	<div class="col col-product-container">
		<div class="product-container">
			<div class="product-name woocommerce-table__product-name product-name">
				<?php
